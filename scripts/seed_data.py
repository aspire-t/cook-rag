...
async def seed_data():
    ...
    engine = create_async_engine(
        "postgresql+asyncpg://cookrag:password@postgres:5432/cookrag",
        echo=False,
    )
    ...
    async with async_session() as session:
        ...
        user = User(
            ...
            hashed_password="$2b$12$K5Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z8Z",  # 占位符
        )
        session.add(user)
        ...
        # 红烧肉食材
        ingredients1 = [
            RecipeIngredient(recipe_id=recipe1.id, ingredient_name="五花肉", amount=500, unit="克", sequence=1),
            RecipeIngredient(recipe_id=recipe1.id, ingredient_name="冰糖", amount=30, unit="克", sequence=2),
            RecipeIngredient(recipe_id=recipe1.id, ingredient_name="料酒", amount=2, unit="勺", sequence=3),
            RecipeIngredient(recipe_id=recipe1.id, ingredient_name="生抽", amount=2, unit="勺", sequence=4),
            RecipeIngredient(recipe_id=recipe1.id, ingredient_name="老抽", amount=1, unit="勺", sequence=5),
            RecipeIngredient(recipe_id=recipe1.id, ingredient_name="姜片", amount=5, unit="片", sequence=6),
            RecipeIngredient(recipe_id=recipe1.id, ingredient_name="葱段", amount=2, unit="根", sequence=7),
            RecipeIngredient(recipe_id=recipe1.id, ingredient_name="八角", amount=2, unit="个", sequence=8),
            RecipeIngredient(recipe_id=recipe1.id, ingredient_name="桂皮", amount=1, unit="小块", sequence=9),
        ]
        ...
        # 麻婆豆腐食材
        ingredients2 = [
            RecipeIngredient(recipe_id=recipe2.id, ingredient_name="嫩豆腐", amount=400, unit="克", sequence=1),
            RecipeIngredient(recipe_id=recipe2.id, ingredient_name="猪肉末", amount=100, unit="克", sequence=2),
            RecipeIngredient(recipe_id=recipe2.id, ingredient_name="豆瓣酱", amount=2, unit="勺", sequence=3),
            RecipeIngredient(recipe_id=recipe2.id, ingredient_name="花椒粉", amount=1, unit="勺", sequence=4),
            RecipeIngredient(recipe_id=recipe2.id, ingredient_name="辣椒粉", amount=1, unit="勺", sequence=5),
            RecipeIngredient(recipe_id=recipe2.id, ingredient_name="蒜末", amount=1, unit="勺", sequence=6),
            RecipeIngredient(recipe_id=recipe2.id, ingredient_name="姜末", amount=1, unit="勺", sequence=7),
            RecipeIngredient(recipe_id=recipe2.id, ingredient_name="葱花", amount=2, unit="勺", sequence=8),
        ]
        ...
        # 番茄炒蛋食材
        ingredients3 = [
            RecipeIngredient(recipe_id=recipe3.id, ingredient_name="鸡蛋", amount=4, unit="个", sequence=1),
            RecipeIngredient(recipe_id=recipe3.id, ingredient_name="番茄", amount=3, unit="个", sequence=2),
            RecipeIngredient(recipe_id=recipe3.id, ingredient_name="白糖", amount=1, unit="勺", sequence=3),
            RecipeIngredient(recipe_id=recipe3.id, ingredient_name="盐", amount=0.5, unit="勺", sequence=4),
            RecipeIngredient(recipe_id=recipe3.id, ingredient_name="葱花", amount=1, unit="勺", sequence=5),
        ]
